...
- org:great-academy
desires:
- To release the truth when the time is right and end the warlords' false legitimacy
- To protect the Academy from retaliation when the truth comes out
fears_or_limits:
- The warlords learning of the hidden repository and destroying the records
