...
desires:
- To understand why the burial cloth did not burn and whether the island is preserved or suffering
- To find a way to release the island's spirit without destroying the cloth — or to accept that it must
  be destroyed
fears_or_limits:
- That she has trapped the island's spirit in a state between living and dead, worse than submergence
