---
id: character:judge-tariq
name: Judge Tariq al-Mir
gm_notes: Tariq is the Pact of the Lamp's enforcer — not through violence but through law. He is the judge
  who interprets contract disputes between binding families and djinn. He is honest, incorruptible, and
  absolutely bound by precedent. If Malik comes to him for a legal remedy, Tariq will help — but only
...
desires:
- To maintain the Pact of the Lamp and the legal order it provides, which is the only thing keeping Al-Khayzar's
  city-states from war.
- To find a legal remedy for the oldest djinn contracts before they begin to break — because when contracts
  break in Al-Khayzar, djinn collect, and collection is not always clean.
fears_or_limits:
- The law may not have a remedy for Malik's contract — it was written three generations ago under different
  precedents. He is honest, which means he will not bend the law to help someone he sympathizes with.
