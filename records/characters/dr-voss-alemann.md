---
id: character:explorer-dr-voss
name: Dr. Voss Alemann
gm_notes: 'Voss is from Valdris — a human academic who came to Verdania to study the temple cities. He
...
desires:
- To map the temple network and find the convergence point he has calculated — the place where all the
  temple sites align.
- To prove his theory that the old civilization was not destroyed but deliberately sealed something.
fears_or_limits:
- The tribal council will not authorize a deep jungle expedition. He is not a fighter and has no survival
  skills beyond basic camp craft. His obsession with the convergence point is making him careless about
  local sensitivities.
current_state:
