...
- to make one perfect sail — a sail that could carry a ship to the edge of the world and back
fears_or_limits:
- that the next sail she makes without the thread will fail and people will die
- that the source of the thread is something she does not want to know — something her mother hid for
  a reason
current_state:
