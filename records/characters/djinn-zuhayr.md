...
desires:
- To resolve the contract with Malik — preferably through renegotiation, because Malik is more useful
  as a willing partner than as a bound servant. But the deadline is real, and Zuhayr cannot extend it
  alone.
- To maintain the Pact of the Lamp, which preserves the peace between the city-states and which he helped
  design.
fears_or_limits:
- He is bound by djinn law as strictly as humans are bound by the contract. He cannot extend the deadline
  without a renegotiation, and a renegotiation requires Malik to initiate. If the contract is broken by
