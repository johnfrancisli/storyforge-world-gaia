...
biography: 'Varg is a guard in Jarl Sigrid''s household, one of the twelve under Captain
  ...
  requests are escalating, and Varg realizes too late that the information he has
  been giving her matches the kind of intelligence someone would need to plan an intrusion.
  He does not know if Sigunn is working for herself or for someone else. The eerie omens during [[experience:the-fog-mothers-warning|the Fog Mother''s warning]] left a permanent impression on their spirit, instilling a deep wariness of the ancient powers lingering in the deep fjords.'
