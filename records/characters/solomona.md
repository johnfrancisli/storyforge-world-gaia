...
desires:
- To build a canoe that can reach his submerged island and recover the stone chest before whatever is
  inside it is fully released
- To find out if the chest is the reason his island sank — and whether the same thing is buried beneath
  other islands
fears_or_limits:
- That whatever is in the chest has already been released and is causing the rising seas
- That he will build the diving canoe and find that the chest is gone — taken by something that got there
  first
current_state:
