---
id: character:tsu-shiori-librarian
name: Shiori
gm_notes: Shiori has discovered records in the shogunal archive that reveal the shrine network was originally
...
desires:
- To find the missing pages of the original pact and determine whether the shrine network can be renewed
  through a new human-yokai agreement.
- To protect the archive's integrity — someone with access is destroying records, and she will find out
  who.
fears_or_limits:
- If the archive's secrets become public, the shrine authority's legitimacy collapses and the shogunate
