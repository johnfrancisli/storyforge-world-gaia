...
desires:
- To cast the hook for 'what the sea has swallowed' and learn what the rising waters have taken that no
  one has noticed
- To understand the full range of what bone hooks can catch — and whether some things should not be caught
fears_or_limits:
- That the hook for 'what the sea has swallowed' will catch something that was swallowed deliberately
  — something that should stay down
