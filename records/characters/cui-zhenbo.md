...
- org:jin-state
desires:
- To confirm whether the crown prince is the poisoner before the warlord dies
- To find an antidote that does not require revealing the poisoning to the court
fears_or_limits:
- Accusing the crown prince wrongly and being executed for treason
