...
biography: 'Koll is a scout and messenger who runs the mountain trails for Jarl Sigrid,
  ...
  — a figure of enormous size, moving between the structures with what looked like
  purpose. Koll has not reported any of this because he does not want the jarl to
  send a war party. He wants to make contact. The eerie omens during [[experience:the-fog-mothers-warning|the Fog Mother''s warning]] left a permanent impression on their spirit, instilling a deep wariness of the ancient powers lingering in the deep fjords.'
