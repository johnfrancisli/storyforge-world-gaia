---
id: character:tsu-kenta-child
name: Kenta
gm_notes: Kenta is Chiyo's (character:tsu-chiyo-child) best friend and the only person who believes her
  ...
  them both from the shadow-creature that Obaba Kiku (character:tsu-baba-storyteller) has been warning
...
- To figure out what the old paper charm he found actually does, and whether it can keep them safe.
fears_or_limits:
- He's a child with a slingshot — whatever Chiyo describes as the 'tall shadow' is beyond anything he
  can fight.
