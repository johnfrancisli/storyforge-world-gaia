...
gm_notes: Chiyo can see and speak with spirits that adults cannot — a gift that most children lose by
  ...
  to her friend Kenta (character:tsu-kenta-child) as if it's a game. She has also mentioned seeing a 'tall
  shadow with too many eyes' near the old sealed stone — the same creature Obaba Kiku (character:tsu-baba-storyteller)
