...
desires:
- To recover all the stone fragments and find someone who can read the script — or determine if it matches
  the wayfinder tattoo patterns
- To understand why deep-water fish are surfacing with these tablets in their bellies — what is releasing
  them from the sea floor
fears_or_limits:
- That the tablets are instructions for something that was deliberately sunk, and assembling them will
  activate it
- That the fish carrying the tablets are not random catches but messengers — and that something sent them
  to him specifically
current_state:
