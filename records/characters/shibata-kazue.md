...
biography: 'Kazue forges blades using an alloy that includes yokai-silver — a material
  ...
  an arsenal specifically for use against yokai — possibly to engineer an incident
  that proves the shrine network''s weakness. She''s torn: the blades are her living,
  but their use could trigger a catastrophe. The scandal of [[experience:the-tea-poison-at-the-moon-viewing|the tea poison at the moon-viewing]] deepened their guarded nature, having seen high samurai and shrine elders throw accusations in the shadow of an attempted murder.'
