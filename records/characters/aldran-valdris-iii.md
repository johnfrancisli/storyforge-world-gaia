---
id: character:aldran-valdris-iii
name: Aldran Valdris III
gm_notes: 'King Aldran knows he is dying. He has a heart condition that his physician has been managing
  quietly with herbal remedies that are becoming less effective. He has three children: the eldest son
  Roderick (ambitious, traditional, backed by the old knightly faction), the daughter Elara (smart, reformist,
  backed by the merchant class), and the youngest son Tomas (seventeen, unaligned, everyone''s wild card).
...
desires:
- To name an heir without triggering a civil war, and to see the dragon order restored before he dies.
fears_or_limits:
- His health is failing. His children are not patient. Naming an heir may start the war he is trying to
