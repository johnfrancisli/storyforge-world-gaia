---
id: character:tattoo-artist-mana
name: Mana the Tattoo-carver
gm_notes: Mana's tattoo work is more than art — each route-map she carves into a wayfinder's skin creates
...
desires:
- To understand why the tattoos that mark submerged routes are aching — and whether the wayfinders are
  holding the sea-routes in existence by carrying them.
- To preserve the route-maps before more are lost, which means carving them on more people, which means
  teaching more wayfinders.
fears_or_limits:
- Her theory — that wayfinder tattoos are anchors for the routes themselves — implies that the rising
  seas are connected to the loss of wayfinders and routes, not just the other way around. This is a dangerous
