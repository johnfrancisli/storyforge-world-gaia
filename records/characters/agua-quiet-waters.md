...
name: Água Quiet-Waters
gm_notes: A Mizuhito canoe maker who builds the vessels that carry the river-cities' people, goods, and
  warriors. Her canoes are valued for their speed, stability, and a subtle quality she calls 'river-sense'
  — an ability to read the current that seems to transfer from builder to vessel. The secret is that Água
  builds a spirit-binding into every canoe she makes, stitching a tiny fragment of her own breath-spirit
  into the hull during construction. This is what gives the canoes their river-sense, but it means each
  canoe she builds permanently reduces her own spirit-strength. She has built over a hundred canoes and
  is beginning to feel the cost — she tires easily, her skin is paler than it should be, and she has started
...
desires:
- To find an apprentice who can learn the breath-binding technique before she is too weak to teach it
- To build one final canoe that is purely craftsmanship with no spirit-cost — a canoe that is just a canoe
fears_or_limits:
