---
id: thread:departing-whales
name: The Departing Whales
thread_type: quest
stakes: If the whales leave, the Archipelago loses its oldest allies and voyaging becomes far more dangerous.
  The displaced islanders cannot be relocated if the sea routes are unsafe. Whatever is driving the whales
  south is connected to the same force that is opening doors and frightening spirits across the world.
pressure: rising
participants:
- character:whale-speaker-fin
...
known_clues: []
next_possible_moves:
- The last family of whales in the northern Archipelago sends a final image to Fin — a clear picture of
  the door, from the other side, showing something behind it that is large and moving — then the whales
  turn south and are gone.
- 'Kai''s attempt to sing to the sea spirits at the deepest water goes wrong: the spirits answer, but
  not in words he recognizes, and the current around his boat changes direction against the wind.'
