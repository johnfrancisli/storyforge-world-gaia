---
id: thread:altacanopy-spirit-nest
name: The Spirit Nest Has Gone Quiet
thread_type: mystery
stakes: If the spirit-pacts are truly broken, every ceremonial artisan, hunter, and healer in Alta Canopy
  loses the source of their craft—and the canopy city's defenses with it. The player could descend to
  find what has silenced the spirits, broker a new pact, or decide whether the child Folha is a symptom
  or a door.
pressure: breaking
participants:
