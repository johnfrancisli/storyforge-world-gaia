---
id: location:alk-basur-foreignquarter
name: The Foreign Quarter
parent_location_id: location:alk-basur
jurisdiction: Each foreign nation's trade-house is under its own consul or headman, who answers to the
  Port-Warden for his people's conduct. The Quarter's taverns and brothels are under a Quarter-Master
  appointed by the Warden. Foreign law applies within the trade-houses; Basuri law in the streets.
terrain: grid of trade-house streets, foreign chapels, taverns, palm-gardens, warehouses
resources:
- foreign goods
- wine
- intelligence
