---
id: location:san-jin-an-city-gate
name: Great Vermilion Gate
parent_location_id: location:jin-an
jurisdiction: Commanded by the Gate General, a military officer appointed directly by the warlord; the
  Gate General controls entry to the capital, manages the gate garrison, and maintains the signal and
  pigeon systems, reporting independently to the palace rather than through the city magistrate.
terrain: Fortified triple-arch gateway with flanking towers
resources:
- entry tolls
- garrison
- signal drums
