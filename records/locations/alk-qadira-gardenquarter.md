---
id: location:alk-qadira-gardenquarter
name: The Garden Quarter
parent_location_id: location:alk-qadira
jurisdiction: Residential quarter under the authority of the Quarter-Elder, elected by the oasis families.
  The Elder handles minor disputes, maintains the lanes and the shared cisterns, and reports to the Water-Sheikh.
  The Quarter is traditionally off-limits to the caravan-clans' animals, a rule enforced by the families'
  own young men.
terrain: narrow shaded lanes, mud-brick courtyard houses, date-palm gardens, kitchen-gardens
resources:
- date-cakes
- date-wine
- rose-attar
