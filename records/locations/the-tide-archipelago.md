---
id: location:tide-archipelago
name: The Tide Archipelago
parent_location_id: null
jurisdiction: Each island is self-governed by a chief or council. The wayfinder guilds mediate between
  islands.
terrain: Islands, reefs, open ocean, volcanic peaks
resources:
- fish
- pearls
- tropical fruit
...
Archipelagan people traditionally use a single personal name. Home islands, crafts, and remembered deeds may be used as contextual descriptions when distinction is needed, but they are not fixed surnames or part of a person's canonical name.
